...
interface AppointmentUpdateEntityEvent extends AppointmentEntityEvent {
    readonly previousEntity: AppointmentEntity;
}
...
export class AppointmentRepository {
    ...
    private async triggerEvent(data: AppointmentEntityEvent | AppointmentUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-appointments-Appointment-Appointment", ["trigger"]);
        ...
        producer.topic("codbex-appointments-Appointment-Appointment").send(JSON.stringify(data));
    }
}
