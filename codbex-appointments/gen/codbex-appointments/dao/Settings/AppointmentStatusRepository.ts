...
interface AppointmentStatusUpdateEntityEvent extends AppointmentStatusEntityEvent {
    readonly previousEntity: AppointmentStatusEntity;
}
...
export class AppointmentStatusRepository {
    ...
    private async triggerEvent(data: AppointmentStatusEntityEvent | AppointmentStatusUpdateEntityEvent) {
